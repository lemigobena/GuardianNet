...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        ...
        try {
            // Admin can login with email, all others must use ID
            const payload = loginId.includes('@') ? { email: loginId, password } : { id: loginId, password };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.inputGroup}>
                    <Text style={styles.label}>{loginId.includes('@') ? 'ADMIN EMAIL' : 'USER ID'}</Text>
                    <TextInput
                        style={styles.input}
                        value={loginId}
                        onChangeText={setLoginId}
                        placeholder="e.g. CT-0000000000"
